    ...
    <div className="w-full xl:w-8/12 mb-12 xl:mb-0 px-4 mx-auto mt-5">
      <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded ">
        ...
        >
          ...
          >
            {currentPage === 1 ? (
              <ArrowLeft styleName="h-6 w-6 disbled" color="#2C2C2C" />
            ) : (
              <ArrowLeft styleName="h-6 w-6" color="#18A0FB" />
            )}
          </button>
          ...
          >
            {currentPage === pagesNumber ? (
              <ArrowRight styleName="h-6 w-6 disabled" color="#2C2C2C" />
            ) : (
              <ArrowRight styleName="h-6 w-6" color="#18A0FB" />
            )}
          </button>
        </div>
      </div>
